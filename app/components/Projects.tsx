...
const projectData = [
...

  {
    title: "Tetris Game",
    description:
      "A classic Tetris game built using C++ to demonstrate game logic, collision detection, and UI rendering. Implemented scoring, line-clearing, and increasing difficulty levels.",
  },

  {
    title: "Attendance Management System",
    description:
      "A file-based C++ system for tracking employee attendance and leave. Tracks weekly working hours, applies leave policies, and generates reports without using a database.",
  },
